...
?>
    ...
    <div class="row px-xl-5 pb-3">
        ...
        $query = "SELECT * FROM t_jenis where  id = 12 ";
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Audio Cable Products</span></h2>
        <div class="row px-xl-5">
            <?php
            // Koneksi ke database
            $koneksi = mysqli_connect("localhost", "root", "", "db_udg");
            ...
            $query = "SELECT id,nama as nama_produk, images,harga,is_featured FROM t_product where id_jenis = 12";
            $result = mysqli_query($koneksi, $query);
 ...
 <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            // Query untuk mengambil data produk
            $query = "SELECT id, nama as nama_produk, images,harga,is_featured FROM t_product where is_new = 'yes' AND id_jenis = 12 ";
            $result = mysqli_query($koneksi, $query);
