...
<!-- Navbar End -->
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            $query = "SELECT id,nama as nama_produk, images,harga,is_featured FROM t_product where is_featured ='yes'";
            $result = mysqli_query($koneksi, $query);
 ...
 <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            // Query untuk mengambil data produk
            $query = "SELECT id, nama as nama_produk, images,harga,is_featured FROM t_product where is_new = 'yes'";
            $result = mysqli_query($koneksi, $query);
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            // Menampilkan produk
            while ($row = mysqli_fetch_assoc($result)) {
                echo '<div class="col-lg-6 col-md-5 col-sm-6 pb-1">';
                echo '<div class="product-item bg-light mb-4">';
                echo '<div class="product-img position-relative overflow-hidden">';
                echo '<center><img src="webp/'. $row['images'] . '" type="image/webp" height="200" width="200"></center>';
                echo '<div class="product-action">';
