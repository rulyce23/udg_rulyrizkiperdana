...
?>
    ...
    <div class="navbar-nav w-100">
        ...
        <div class="nav-item dropdown dropright">
            ...
            <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                ...
                <a href="fightcase.php" class="dropdown-item active">Flight Cases</a>
    ...
    <div class="row px-xl-5 pb-3">
        ...
        $query = "SELECT * FROM t_jenis where id = 1 OR id = 10  OR id = 8 OR id = 18 OR id = 19 OR id = 20 ";
    ...
    <!-- Products Start -->
    <div class="container-fluid pt-7 pb-4">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Media Source Products</span></h2>
        <div class="row px-xl-4">
            ...
            $query = "SELECT id,nama as nama_produk, images,harga,is_featured FROM t_product where id_jenis = 1 OR id_jenis = 8 OR id_jenis = 10 OR id_jenis = 18 OR id_jenis = 19 OR id_jenis = 20";
            $result = mysqli_query($koneksi, $query);
    
            // Menampilkan produk
            while ($row = mysqli_fetch_assoc($result)) {
                echo '<div class="col-lg-6 col-md-8 col-sm-11 pb-2">';
                echo '<div class="product-item bg-light mb-4">';
                echo '<div class="product-img position-relative overflow-hidden">';
                echo '<center><img src="webp/'. $row['images'] . '" type="image/webp" height="200" width="200"></center>';
                echo '<div class="product-action">';
 ...
 <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            // Query untuk mengambil data produk
            $query = "SELECT id, nama as nama_produk, images,harga,is_featured FROM t_product where is_new = 'yes' AND id_jenis = 1 OR is_new = 'yes' AND id_jenis = 8 OR is_new = 'yes' AND id_jenis = 10 OR is_new = 'yes' AND id_jenis = 18 OR is_new = 'yes' AND id_jenis = 19 OR is_new = 'yes' AND id_jenis = 20 ";
            $result = mysqli_query($koneksi, $query);
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '</div>';
                echo '<div class="text-center py-4">';
                echo '<a class="h6 text-decoration-none text-truncate" style="font-size:11px; font-style:bold;" href="">' . $row['nama_produk'] . '</a>';
                echo '<div class="d-flex align-items-center justify-content-center mt-2">';
                echo '<h7>IDR Rp.' . $row['harga'] . '</h7>';
                echo '</div>';
                // echo '<div class="d-flex align-items-center justify-content-center mb-1">';
