...
<body>
    ...
    <div class="navbar-nav w-100">
        <div class="nav-item dropdown dropright">
            ...
            <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                ...
                <a href="mediasource.php" class="dropdown-item active">Media Sources</a>
    ...
    <div class="row px-xl-5 pb-3">
        ...
        $query = "SELECT * FROM t_jenis where id = 2 OR id = 5 OR id = 9 OR id = 11 ";
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            $query = "SELECT id,nama as nama_produk, images,harga,is_featured FROM t_product where id_jenis = 2 OR id_jenis = 5 OR id_jenis = 9 OR id_jenis = 11";
            $result = mysqli_query($koneksi, $query);
 ...
 <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            // Query untuk mengambil data produk
            $query = "SELECT id, nama as nama_produk, images,harga,is_featured FROM t_product where is_new = 'yes' AND id_jenis = 2 OR is_new = 'yes' AND id_jenis = 5 OR is_new = 'yes' AND id_jenis = 9 OR is_new = 'yes' AND id_jenis = 11 ";
            $result = mysqli_query($koneksi, $query);
