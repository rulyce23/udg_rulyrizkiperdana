...
?>
    ...
    <div class="navbar-nav w-100">
        <div class="nav-item dropdown dropright">
            ...
            <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                <a href="device.php" class="dropdown-item active">Device</a>
    ...
    <div class="row px-xl-5 pb-3">
        ...
        $query = "SELECT * FROM t_jenis where id = 1 OR id = 4 OR id = 8 OR id = 10";
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Device Products</span></h2>
        <div class="row px-xl-5">
            <?php
            // Koneksi ke database
            $koneksi = mysqli_connect("localhost", "root", "", "db_udg");
            ...
            $query = "SELECT id,nama as nama_produk, images,harga,is_featured FROM t_product where id_jenis = 1 OR id_jenis = 4 OR id_jenis = 8 OR id_jenis = 10";
            $result = mysqli_query($koneksi, $query);
 ...
 <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            // Query untuk mengambil data produk
            $query = "SELECT id, nama as nama_produk, images,harga,is_featured FROM t_product where is_new = 'yes' AND id_jenis = 1 OR is_new = 'yes' AND id_jenis = 4 OR is_new = 'yes' AND id_jenis = 8 OR is_new = 'yes' AND id_jenis = 10 ";
            $result = mysqli_query($koneksi, $query);
            ...
            while ($row = mysqli_fetch_assoc($result)) {
               ...
               echo '</div>';
                echo '</div>';
                echo '<div class="text-center py-4">';
                echo '<a class="h6 text-decoration-none text-truncate" href="">' . $row['nama_produk'] . '</a>';
                echo '<div class="d-flex align-items-center justify-content-center mt-2">';
                echo '<h7>IDR Rp.' . $row['harga'] . '</h7>';
                echo '</div>';
                // echo '<div class="d-flex align-items-center justify-content-center mb-1">';
