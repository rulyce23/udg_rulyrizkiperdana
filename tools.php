...
?>
    ...
    <div class="navbar-nav w-100">
        <div class="nav-item dropdown dropright">
            ...
            <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                ...
                <a href="tools.php" class="dropdown-item active">Tools</a>
            </div>
        </div>
        <div class="nav-item dropdown dropright">
    ...
    <div class="row px-xl-5 pb-3">
        ...
        $query = "SELECT * FROM t_jenis where id = 3 OR id = 7 OR id = 12 OR id = 16 OR id = 17 ";
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Tools Products</span></h2>
        <div class="row px-xl-5">
            <?php
            // Koneksi ke database
            $koneksi = mysqli_connect("localhost", "root", "", "db_udg");
            ...
            $query = "SELECT id,nama as nama_produk, images,harga,is_featured FROM t_product where id_jenis = 3 OR id_jenis = 7 OR id_jenis = 12 OR id_jenis = 16 OR id_jenis = 17 ";
            $result = mysqli_query($koneksi, $query);
 ...
 <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            // Query untuk mengambil data produk
            $query = "SELECT id, nama as nama_produk, images,harga,is_featured FROM t_product where is_new = 'yes' AND id_jenis = 3 OR  is_new = 'yes' AND id_jenis = 7 OR  is_new = 'yes' AND id_jenis = 12 OR  is_new = 'yes' AND id_jenis = 16 OR  is_new = 'yes' AND id_jenis = 17 ";
            $result = mysqli_query($koneksi, $query);
    
            // Menampilkan produk
            while ($row = mysqli_fetch_assoc($result)) {
                echo '<div class="col-lg-4 col-md-4 col-sm-6 pb-1">';
                echo '<div class="product-item bg-light mb-4">';
                echo '<div class="product-img position-relative overflow-hidden">';
                echo '<center><img src="webp/'. $row['images'] . '" type="image/webp" height="200" width="200"></center>';
                echo '<div class="product-action">';
